...
private:
    ...
    inline AlphaNum& operator=(const AlphaNum& right) {
        right;
        return *this;
    };

    inline const Subset& getAlpha(void) const {
        return _alpha;
    };

    inline const Subset& getNum(void) const {
        return _numeric;
    };
...
private:
    ...
    inline StringCheck& operator=(const StringCheck& right) {
        right;
        return *this;
    };

    inline const Subset& getQuote(void) const {
        return _stringQuote;
    };
...
private:
    ...
    inline IntegerCheck& operator=(const IntegerCheck& right) {
        right;
        return *this;
    };

    inline const Subset& getDigits(void) const {
        return _digit;
    };
...
public:
    ...
    inline int StrToInt(const std::string& str) const {
...
public:
    ...
    inline bool operator==(const SymbolInfo& right) const {
...
private:
    ...
    inline tableType& getTable(void) {
        return _symbolTable;
    };

    inline const tableType& getTable(void) const {
        return _symbolTable;
    };
...
public:
    ...
    inline const second_type getSymbol(const first_type& keyType) const {
        return findSecond(keyType);
    };
    ...
    inline void printSymbolTable(void) {
        for (tableType::const_iterator it = getTable().begin(); it != getTable().end(); ++it) cout << endl << it->first << " " << it->second.getName() << endl;
    };
};
